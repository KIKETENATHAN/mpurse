                ...
                <div class="intro-contain">
                    <div>
                        <h1 class="wow fadeInLeft"
                            data-wow-duration="1s"><?php echo e(__('DRMS SaaS - Digital Record Management System')); ?></h1>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s"><?php echo e(__('Document and Records Management System (DRMS SaaS) software refers to the various features and functionalities that the software offers to help organizations manage their digital documents effectively.')); ?></p>
                        ...
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    ...
                                    <p><?php echo e(__('DRMS SaaS software refers to the various features and functionalities that the software offers to help organizations manage their digital documents effectively.')); ?></p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('Subscription Plan')); ?></h5>
                                    <p><?php echo e(__('DRMS SaaS software refers to the various features and functionalities that the software offers to help organizations manage their digital documents effectively.')); ?></p>
                                </a>
                            </div>
                        </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('Document Details')); ?></h5>
                                    <p><?php echo e(__('DRMS SaaS software refers to the various features and functionalities that the software offers to help organizations manage their digital documents effectively.')); ?></p>
                                </a>
                            </div>
                        </div>
                ...
                <div>
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5><?php echo e(__('User Logged History')); ?></h5>
                                    <p><?php echo e(__('DRMS SaaS software refers to the various features and functionalities that the software offers to help organizations manage their digital documents effectively.')); ?></p>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        ...
                        <ul class="cdxprice-list">
                            ...
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i><?php echo e($subscription->document_limit); ?></span><?php echo e(__('Document Limit')); ?></li>
                            ...
                            <li>
                                ...
                                <?php endif; ?>
                                <?php echo e(__('Document History')); ?>
        ...
        <div class="row cdx-row">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="demo-grid">
                    ...
                    <div class="demo-detail">
                        <h3><?php echo e(__('Subscription Plan')); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="demo-grid">
                    ...
                    <div class="demo-detail">
                        <h3><?php echo e(__('Document History')); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="demo-grid">
                    ...
                    <div class="demo-detail">
                        <h3><?php echo e(__('User Logged History')); ?></h3>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/mpurseco/public_html/vms/resources/views/layouts/landing.blade.php ENDPATH**/ ?>